...
import { deleteAdmin, getAdminById, getAllAdmins, toggleAdminStatus, updateUserRole } from "./admin.controller.js";
import {auth} from "../../middleware/auth.js";
import validation from "../../middleware/validation.js"
import {deleteAdminSchema, getAdminByIdSchema, toggleAdminStatusSchema, updateUserRoleSchema} from './admin.validation.js';
const router = Router();
