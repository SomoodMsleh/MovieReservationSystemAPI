...
import { deleteAdmin, forceResetPassword, getAdminById, getAdminStats, getAllAdmins, toggleAdminStatus, updateUserRole } from "./admin.controller.js";
...
router.get('/stats',auth(['superAdmin']), asyncHandler(getAdminStats));
